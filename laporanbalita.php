...
<body>
    <div id="container">
        ...
        <div id="isi" style="height:100%; width:100%; float:left; padding-top: 3%; padding-bottom: 3%;">
            ...
            <form action="laporanbalita.php" method="post">
                <b style="font-size: 30px;"><center>DATA BALITA</center></b><br>
            ...
            if(isset($_POST['tgl'])){
                ...
                if ($cek>0) {
                    ?>
                    <button type="submit" class="btn" style="float: left; background-color: #FF0000; color: white; margin-left: 10%;" onclick="window.location.href='printpdfbalita.php?tgl=<?php echo $tgl; ?>'">PRINT PDF</button>
                    <button type="submit" class="btn" style="float: left; background-color: #228B22; color: white; margin-left: 3%;" onclick="window.location.href='printexcelbalita.php?tgl=<?php echo $tgl; ?>'">PRINT EXCEL</button>
                    <br>
                    <br>
                    <table id="cari">
                        <tr>
