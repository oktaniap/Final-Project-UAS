    ...
    <div id="container">
        ...
        <div id="isi" style="height:100%; width:100%; float:left; padding-top: 3%; padding-bottom: 3%;">
            <div style="background-color:rgba(152,251,152,0.5); height: 100%; padding-bottom: 5%;"><br><br>
                ...
                <b style="font-size: 30px;"><center>DAFTAR DATA POSYANDU TANJUNG 1</center></b><br><br>
                ...
                <button type="submit" class="btn" style="background-color: #008B8B; color: white;margin-left: 21cm; margin-bottom: 2px;">CARI</button>
                </form>
                <br><br>
                        ...
                        if (isset($_GET['cari'])=="") {
                            ...
                            while ($row=mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="window.location.href='previewdata.php?preview=1&nik=<?php echo $row[0];?>'">PREVIEW DATA</button></td>
                                </tr>
                                <?php
                            }
