    ...
    <div id="container">
        <div id="header">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="pemeriksaan.php" style="font-size: 15px;"><i class="fa fa-stethoscope"></i> Pemeriksaan Kesehatan</a><ul class="sub1">
        ...
        <div id="isi" style="height:100%; width:100%; float:left; padding-top: 30px; padding-bottom: 30px;">
            <div style="background-color:rgba(152,251,152,0.5); height: 100%; padding-bottom: 50px;"><br><br>
                ...
                <b style="font-size: 30px;"><center>EDIT DATA ANGGOTA POSYANDU</center></b><br><br>
                <font style="font-size: 18px; letter-spacing: 0.3px; padding-left: 2cm; font-weight: bold;">
                PILIH DATA YANG AKAN DI EDIT</font>
                <br><br>
                        ...
                        if (isset($_GET['cari'])=="") {
                            ...
                            while ($row=mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="window.location.href='update.php?edit=1&nik=<?php echo $row['nik'];?>'">EDIT</button>
                                        <button class="btn btn-primary" onclick="window.location.href='hapus.php?hapus=1&nik=<?php echo $row['nik'];?>'">HAPUS</button></td>
                                </tr>
                                <?php
                            }
                            ...
                            while ($row=mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-primary" onclick="window.location.href='update1.php?edit=1&nik=<?php echo $row['nik'];?>'">EDIT</button>
                                        <button class="btn btn-primary" onclick="window.location.href='hapus1.php?hapus=1&nik=<?php echo $row['nik'];?>'">HAPUS</button></td>
                                </tr>
                                <?php
                            }
                        }else{
                                        ...
                                        <tr>
                                            ...
                                            <script>
                                                function konfirmasi(){
                                                    ...
                                                    if(konfirmasi === true) {
                                                        window.location.href='hapus.php?hapus=1&nik=<?php echo $row['nik'];?>';
                                                    }else{
                                                        window.location.href='edit.php?';
                                                    } 
                                                }
                                            </script>
                                            <button class="btn btn-primary" onclick="konfirmasi()">HAPUS</button></td>
                                        </tr>
                                        <?php
                                    }
                                            ...
                                            <td><button class="btn btn-primary" onclick="window.location.href='update1.php?edit=1&nik=<?php echo $row['nik'];?>'">EDIT</button>
                                                <script>
                                                    function konfirmasi1(){
                                                        var konfirmasi = confirm("Yakin ingin menghapus data?");             
                                                        if(konfirmasi === true) {
                                                            window.location.href='hapus1.php?hapus=1&nik=<?php echo $row['nik'];?>';
                                                        }else{
                                                            window.location.href='edit.php?';
                                                        } 
                                                    }
                                                </script>
                                                <button class="btn btn-primary" onclick="konfirmasi1()">HAPUS</button></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
