    ...
    <div id="container">
        ...
        <div id="isi" style="height:100%; width:100%; float:left; padding-top: 30px; padding-bottom: 30px;">
            <div style="background-color:rgba(152,251,152,0.5); height: 100%; padding-bottom: 50px;"><br><br>
                <form action="imunisasi.php" method="get">
                ...
                <div style="text-align: center;">
                    <table id="cari">
                        ...
                        $tanggal=date("Y-m-d");
                        if (isset($_GET['cari'])=="") {
                            $sql="SELECT * FROM cek WHERE tgl = '$tanggal'";
                            ...
                            while ($row=mysqli_fetch_array($query)) {
                                ...
                                while ($row1=mysqli_fetch_array($query1)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php $date=date("Y-m-d");
                                            ...
                                            echo $bln."&nbspBulan";
                                            ?></td>
                                        <td><button class="btn btn-primary" onclick="window.location.href='imunisasi1.php?imun=1&nik=<?php echo $row['nik'];?>'">CEK</button></form></td>
                                    </tr>
                                    <?php
                                }
                                ...
                                while ($row2=mysqli_fetch_array($query2)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-primary" onclick="window.location.href='imunisasi1.php?imun=1&nik=<?php echo $row['nik'];?>'">CEK</button></td>
                                    </tr>
                                    <?php
                                }
                            }
