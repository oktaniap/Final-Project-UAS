    ...
    <div id="container">
        ...
        <div id="isi" style="height:100%; width:100%; float:left; padding-top: 30px; padding-bottom: 30px;">
            <div style="background-color:rgba(152,251,152,0.5); height: 100%; padding-bottom: 50px;"><br><br>
                ...
                <button class="btn" style="margin-left: 5%; background-color: #008B8B; color: white;" onclick="window.location.href='imunisasi.php'">KEMBALI</button><br><br>
                    ...
                    if ($_GET['imun']==2) {
                        ...
                        while ($row=mysqli_fetch_array($query)) {
                            ...
                            <table style="text-align: left; margin-left: 5cm;">
                                ...
                                ?>
                                <br><br>
                                <button class="btn btn-primary" onclick="window.location.href='imunisasi3.php?update=1&nik=<?php echo $nik;?>&tgl=<?php echo $tanggal; ?>'" style="margin-left: 5%;">UPDATE DATA</button>
                                <?php
                        }
